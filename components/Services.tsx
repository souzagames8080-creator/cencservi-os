...
const ServicesGrid: React.FC<ServicesGridProps> = ({ content }) => {
  return (
    <section id="servicos" className="py-20 lg:py-32 bg-[#020b13]">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6 max-w-7xl mx-auto">
          {INITIAL_SERVICES.map((service) => (
            <div 
              key={service.id} 
              className="bg-[#051421] p-8 lg:p-10 rounded-3xl lg:rounded-[40px] border border-white/5 flex flex-col items-center text-center group hover:bg-[#0a253a] hover:border-teal/30 transition-all duration-500 shadow-2xl deep-glow"
            >
              <div className="w-16 h-16 lg:w-20 lg:h-20 bg-[#020b13] text-teal rounded-2xl lg:rounded-3xl flex items-center justify-center mb-6 lg:mb-8 group-hover:bg-teal group-hover:text-white transition-all shadow-2xl border border-white/5">
          ...
          <div className="col-span-full mt-16 lg:mt-24 bg-[#051421] p-8 lg:p-24 rounded-[40px] lg:rounded-[80px] border border-white/5 flex flex-col items-center text-center relative overflow-hidden shadow-2xl">
             <div className="absolute inset-0 bg-teal/[0.03] blur-3xl rounded-full -z-10"></div>
             ...
             <div className="space-y-6 lg:space-y-8 relative z-10 max-w-2xl mx-auto w-full">
                ...
                <div className="flex flex-col items-center gap-4 lg:gap-6 w-full">
                  ...
                  >
                    ...
                    <div className="relative bg-[#020b13]/80 backdrop-blur-md border border-white/20 p-2 rounded-2xl lg:rounded-[36px] flex items-center group-hover:border-[#25D366]/50 transition-all duration-500 overflow-hidden shadow-2xl">
